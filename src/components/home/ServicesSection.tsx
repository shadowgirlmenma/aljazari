 ...
 * كل بطاقة رابط للصفحة الخاصة بالخدمة. الصور (ملاحظة 25/09): مصممة خصيصاً بنفس
 * هوية الموقع (زجاجي بنفسجي متوهج) بدل صور فوتوغرافية عامة، وكل صورة تعكس موضوعها
 * (روبوت لحلول الروبوتات، شريحة AI لحلول الذكاء الاصطناعي، قبعة تخرّج للتدريب).
 */
const SERVICES: { key: string; image: string; href: '/robot-solutions' | '/ai-solutions' | '/training' }[] = [
  { key: 'robotSolutions', image: '/services/robotics-solutions.webp', href: '/robot-solutions' },
  { key: 'ai',             image: '/services/ai-solutions.webp',       href: '/ai-solutions' },
  { key: 'training',       image: '/services/training-programs.webp', href: '/training' },
];
