              ...
              return (
                ...
                >
                  <Link
                    ...
                    className="group relative flex aspect-[5/4] flex-col justify-end overflow-hidden rounded-2xl border border-purple-300/15 transition-all duration-300 hover:-translate-y-1 hover:scale-[1.015] hover:border-purple-300/40 hover:shadow-2xl hover:shadow-brand-700/25"
                  >
                    <Image
                      src={image}
