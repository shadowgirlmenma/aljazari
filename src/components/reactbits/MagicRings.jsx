...
export default function MagicRings({
  color = '#7c47e0', colorTwo = '#4c1d80', speed = 0.8, ringCount = 5,
  attenuation = 8, lineThickness = 1.5, baseRadius = 0.3, radiusStep = 0.12,
  scaleRate = 0.1, opacity = 0.9, blur = 0, noiseAmount = 0.05, rotation = 0,
  ringGap = 1.4, fadeIn = 0.7, fadeOut = 0.5, followMouse = true,
  mouseInfluence = 0.15, hoverScale = 1.1, parallax = 0.04, clickBurst = true,
}) {
