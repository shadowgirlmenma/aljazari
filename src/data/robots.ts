...
export const ROBOTS: Robot[] = [
  // ══════════════════════ بشرية ══════════════════════
  {
    ...
    specs: [
      { label: { ar: 'الشاشة', en: 'Display' }, value: 'High-quality touchscreen' },
  ...
  // ══════════════════════ خدمية ══════════════════════
  {
    ...
    specs: [
      { label: { ar: 'الشاشة', en: 'Display' }, value: 'Digital ad screen for images & video' },
      { label: { ar: 'البطارية', en: 'Battery' }, value: 'Hot-swappable' },
      { label: { ar: 'الشحن', en: 'Charging' }, value: 'Smart fast charging' },
    ],
    hardware: [
