...
export const ROBOTS: Robot[] = [
  // ══════════════════════ بشرية ══════════════════════
  {
    ...
    gallery: [
      ...
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=kr05reBxVRs' },
    ],
    tagline: { ar: 'روبوت بشري', en: 'Humanoid robot' },
    summary: {
      ar: 'بيبر هو روبوت اجتماعي شبيه بالبشر، مصمم للتواصل بشكل طبيعي مع الناس وخلق تفاعلات هادفة. يُستخدم على نطاق واسع في محلات البيع بالتجزئة وخدمة العملاء للترحيب بالضيوف وتقديم المساعدة وتوفير تجربة تفاعلية شبيهة بالبشر.',
      en: 'Pepper is a social humanoid robot created to communicate naturally with people and create meaningful interactions. It is widely used in retail and customer service to welcome guests, provide assistance, and deliver an engaging human-like experience.',
    },
    features: [
      {
        title: { ar: 'سهل الاستخدام', en: 'Easy to use' },
        description: {
          ar: 'نظام إدارة محتوى بديهي يسهّل تخصيص محادثات بيبر وتفاعلاته.',
          en: 'An intuitive content management system makes it easy to tailor Pepper’s conversation and interactions.',
        },
      },
      {
        title: { ar: 'يجمع بيانات مفيدة', en: 'Gathers data that matters' },
        description: {
          ar: 'يلتقط ملاحظات الزبائن أثناء المحادثة، وهذي الرؤى تُدمج مباشرة مع نظام CRM.',
          en: 'Pepper naturally captures customer feedback over the course of conversation — these real-time insights can be integrated directly with your CRM system.',
        },
      },
      {
        title: { ar: 'احترافية مستمرة', en: 'The consummate professional' },
        description: {
          ar: 'ثابت وودود ومرحّب دائماً، يضمن إن كل تفاعل مع كل زبون أو موظف إيجابي واحترافي.',
          en: 'Always consistent, always friendly and welcoming, Pepper ensures that every interaction with every customer or staff member is positive and professional.',
        },
      },
      {
        title: { ar: 'يعرف علامتك التجارية', en: 'Knows your brand' },
        description: {
          ar: 'يدمج كل بيانات العروض والمخزون والتسعير، ويعمل كقاعدة معرفة فورية للزبائن والموظفين.',
          en: 'Pepper integrates all of your promotional, inventory, and pricing data, acting as a go-to, real-time knowledge base for customers and employees alike.',
        },
      },
      {
        title: { ar: 'يتواصل مع الناس', en: 'Connects with people' },
        description: {
          ar: 'يتواصل بالكلام ونظرات العين ولغة الجسد، ما يخلي كل تفاعل ممتع ومفيد ومؤثر بعلامتك التجارية.',
          en: 'Communicating through words, eyes, and body language, Pepper makes every customer interaction fun, memorable, and informative, and drives engagement with your brand.',
        },
      },
      {
        title: { ar: 'يجمع الرقمي والمادي', en: 'Combines the digital and the physical' },
        description: {
          ar: 'بدمجه مع حلول التسويق الرقمي والتجارة الإلكترونية، ينقل بيبر أفضل ما بموقعك إلى مواقعك الفعلية — بما فيها البحث والتوصيات.',
          en: 'By integrating with your digital marketing and e-commerce solutions, Pepper brings all the best parts of your website to your real-world locations — including search and recommendations.',
        },
      },
    ],
    specs: [
      { label: { ar: 'الأبعاد', en: 'Dimensions' }, value: 'Height 1210 mm · Base ⌀ ~425 mm · Weight ~28 kg' },
      { label: { ar: 'اللوحة الأم', en: 'Motherboard' }, value: 'x86-based CPU · 4 GB RAM · 32 GB storage' },
      { label: { ar: 'البطارية', en: 'Battery' }, value: 'Lithium-ion, 29.2 V nominal, ~795 Wh' },
      { label: { ar: 'مداخل الطاقة', en: 'Power entries' }, value: 'Dedicated charging connector · External 29.2 V DC / 8 A' },
      { label: { ar: 'الاتصال', en: 'Connectivity' }, value: 'Wi-Fi 802.11 a/b/g/n · Bluetooth 2.1+EDR · Ethernet via USB' },
      { label: { ar: 'الشاشة اللوحية', en: 'Tablet' }, value: '10.1″, 1280 × 800, capacitive multi-touch, Android 4.4.2' },
      { label: { ar: 'مكبرات الصوت', en: 'Loudspeakers' }, value: 'Stereo, head & body, ~150 Hz – 20 kHz' },
      { label: { ar: 'الميكروفونات', en: 'Microphones' }, value: '4× directional array — voice capture & sound localization' },
      { label: { ar: 'كاميرات ثنائية الأبعاد', en: '2D cameras' }, value: '2× head-mounted, CMOS 5MP, up to 2560×1920@1fps / 640×480@30fps, ~67.4° FOV' },
      { label: { ar: 'مستشعر ثلاثي الأبعاد', en: '3D sensor' }, value: 'Structured light (ASUS Xtion), 320×240 @ 20 fps' },
      { label: { ar: 'مؤشرات LED', en: 'LEDs' }, value: 'RGB — eyes, shoulders, chest (status & expression)' },
      { label: { ar: 'وحدة القصور الذاتي (IMU)', en: 'Inertial unit (IMU)' }, value: '3-axis gyroscope ±500°/s · 3-axis accelerometer ±2 g' },
      { label: { ar: 'أجهزة الليزر', en: 'Lasers' }, value: '6× laser line projectors — obstacle detection' },
      { label: { ar: 'الأشعة تحت الحمراء', en: 'Infra-red' }, value: 'IR proximity sensors — short-range detection' },
      { label: { ar: 'أجهزة السونار', en: 'Sonars' }, value: '2×, 42 kHz, 0.25–3.0 m range, ~60° angle' },
      { label: { ar: 'وحدة تنظيم المحركات (MRE)', en: 'Motor regulation (MRE)' }, value: 'Motor control, feedback & safety management' },
      { label: { ar: 'المحركات', en: 'Motors' }, value: '20 DOF electric DC motors (Head 2 · Arms 10 · Hands 4 · Base 4)' },
      { label: { ar: 'مستشعرات اللمس', en: 'Contact & tactile sensors' }, value: 'Capacitive touch — head, hands' },
      { label: { ar: 'محطة الشحن', en: 'Charging station' }, value: 'Docking station, AC mains input, 29.2 V DC output' },
    ],
    hardware: [
    ...
    sectors: ['healthcare', 'banking', 'malls', 'hospitality'],
  },
  {
    slug: 'timo',
    name: 'Timo',
  ...
  },
  {
    ...
    specs: [
      ...
      { label: { ar: 'كاميرا حرارية', en: 'Thermal camera' }, value: 'Built-in' },
      { label: { ar: 'مدى الميكروفون', en: 'Microphone range' }, value: '3 – 5 m' },
      { label: { ar: 'مكبرات الصوت', en: 'Speakers' }, value: '2 × 3 inch' },
      { label: { ar: 'زمن التشغيل', en: 'Runtime' }, value: 'Up to 8 hours' },
  ...
  },
  {
    ...
    specs: [
      { label: { ar: 'الشاشة', en: 'Display' }, value: 'Interactive touchscreen' },
      { label: { ar: 'الكاميرات', en: 'Cameras' }, value: 'Face recognition + face detection' },
      { label: { ar: 'الملاحة', en: 'Navigation' }, value: 'LiDAR + IMU + obstacle sensors' },
    ],
    hardware: [
  ...
  // ══════════════════════ خدمية ══════════════════════
  {
    ...
    gallery: [
      ...
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=C6mDHR-e8mw' },
    ],
    tagline: { ar: 'روبوت خدمي', en: 'Service robot' },
    summary: {
      ar: 'روبوت BellaBot Pro هو روبوت خدمة ذكي متعدد الاستخدامات يقدم توصيل الطلبات والترحيب والتفاعل مع العملاء في المطاعم، الفنادق، والفعاليات، ويتنقل بأمان في البيئات المعقدة مع قدرة تفاعلية جذابة وشاشات عرض للمحتوى التسويقي.',
      en: 'BellaBot Pro is an intelligent service robot for delivery, guest engagement, and interactive experiences in restaurants, hotels, and event spaces, navigating safely through complex environments while offering engaging interaction and integrated marketing displays.',
    },
    features: [
      {
        title: { ar: 'روبوت توصيل ذكي', en: 'Intelligent delivery robot' },
        description: {
          ar: 'مصمم للمطاعم والفنادق وأماكن الخدمة.',
          en: 'Built for restaurants, hotels, and service venues.',
        },
      },
      {
        title: { ar: 'تفاعل ودّي وجذاب', en: 'Friendly, engaging interaction' },
        description: {
          ar: 'يتفاعل مع الزبائن بأسلوب ودّي وجذاب.',
          en: 'Engages customers in a warm, delightful way.',
        },
      },
      {
        title: { ar: 'شاشة عرض تفاعلية كبيرة', en: 'Large interactive display' },
        description: {
          ar: 'لعرض العلامة التجارية والعروض الترويجية.',
          en: 'For branding and promotional content.',
        },
      },
      {
        title: { ar: 'تنقّل آمن', en: 'Safe navigation' },
        description: {
          ar: 'بالبيئات المزدحمة والمتغيّرة.',
          en: 'Through crowded and dynamic environments.',
        },
      },
      {
        title: { ar: 'أدراج حمل بالتعرف على الأطباق', en: 'Trays with dish recognition' },
        description: {
          ar: '4 أدراج بسعة 10 كغم لكل درج، مع خاصية التعرف على الأطباق.',
          en: '10kg × 4 trays with automatic dish recognition.',
        },
      },
    ],
    specs: [
      { label: { ar: 'أبعاد الجهاز', en: 'Machine dimensions' }, value: '57 × 55 × 129 cm (22.44 × 21.65 × 50.79 in)' },
      { label: { ar: 'وزن الجهاز', en: 'Machine weight' }, value: '55 kg (121.25 lb)' },
      { label: { ar: 'أقصى حمولة', en: 'Maximum load' }, value: '40 kg (10 kg / tray)' },
      { label: { ar: 'مقاس الدرج', en: 'Tray size' }, value: '410 × 500 mm (16.14 × 19.69 in)' },
      { label: { ar: 'وقت الشحن', en: 'Charging time' }, value: '4.5 h' },
      { label: { ar: 'مدة التشغيل', en: 'Run-time' }, value: '11 h (no load)' },
      { label: { ar: 'سرعة التنقّل', en: 'Cruise speed' }, value: '0.2–1.2 m/s (0.66–3.94 ft/s, adjustable)' },
      { label: { ar: 'الشاشات', en: 'Screens' }, value: '10.1″ LCD + 18.5″ LCD' },
      { label: { ar: 'طرق الملاحة', en: 'Navigation methods' }, value: 'VSLAM + Marker + Lidar SLAM' },
      { label: { ar: 'أدنى مسافة مرور', en: 'Path clearance' }, value: '65 cm (25.59 in)' },
    ],
    hardware: [
      { label: { ar: 'شاشة إعلانية تفاعلية لعرض الصور والفيديوهات', en: 'Interactive advertising display' }, side: 'start' },
      { label: { ar: 'خاصية التعرف على نوع الأطباق', en: 'Dish-type detection' }, side: 'end' },
    ],
    sectors: ['restaurants', 'malls', 'hospitality', 'showroom', 'events'],
  },
  {
    slug: 'kittybot-pro',
    name: 'KettyBot Pro',
  ...
  },
  {
    ...
    gallery: [
      ...
      '/robots/pudubot-real-3.webp',
      '/robots/pudubot-real-4.webp',
      '/robots/pudubot-real-5.webp',
      '/robots/pudubot-real-6.webp',
    ],
    tagline: { ar: 'روبوت خدمي', en: 'Service robot' },
    summary: {
    ...
    specs: [
      ...
      { label: { ar: 'زمن الشحن', en: 'Charging time' }, value: '4 h' },
      { label: { ar: 'عمر البطارية', en: 'Battery life' }, value: '10 – 24 h (swappable)' },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: { ar: 'الشحن التلقائي', en: 'Auto-charging' }, value: 'Optional (charging dock on request)' },
    ],
    hardware: [
  ...
  // ══════════════════════ تعليمية ══════════════════════
  {
    ...
    gallery: [
      ...
      '/robots/nao-real-3.webp',
      '/robots/nao-real-4.webp',
      '/robots/nao-real-5.webp',
      '/robots/nao-real-6.webp',
      '/robots/nao-real-7.webp',
      '/robots/nao-real-8.webp',
      '/robots/nao-real-9.webp',
      '/robots/nao-real-10.webp',
      '/robots/nao-real-11.webp',
    ],
    ...
    specs: [
      ...
      { label: { ar: 'الميكروفونات', en: 'Microphones' }, value: 'Front, rear & side' },
      { label: { ar: 'الاستشعار', en: 'Sensing' }, value: '2 × sonar / ultrasonic + touch sensors' },
      { label: { ar: 'المفاصل', en: 'Joints' }, value: 'Head, hock, wrist, hip, knee, ankle' },
      { label: { ar: 'اليدين', en: 'Hands' }, value: 'Articulated fingers' },
    ],
    hardware: [
  ...
  },
  {
    ...
    specs: [
      ...
      { label: { ar: 'الصوت', en: 'Audio' }, value: 'Surround sound' },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: { ar: 'المحركات', en: 'Motors' }, value: '4 × encoder geared motors' },
      { label: { ar: 'المتحكم', en: 'Controller' }, value: 'mini STM32' },
      { label: { ar: 'البطارية', en: 'Battery' }, value: 'Li-ion 11.1 V 6000 mAh' },
      { label: { ar: 'الهيكل', en: 'Chassis' }, value: 'Anodized metal chassis' },
    ],
    hardware: [
  ...
  },
  {
    ...
    specs: [
      ...
      { label: { ar: 'الشاشة', en: 'Display' }, value: 'LCD 7 inch' },
      { label: { ar: 'الكاميرا', en: 'Camera' }, value: '3D depth camera' },
      { label: { ar: 'المحركات', en: 'Servos' }, value: 'Smart bus servo' },
      { label: { ar: 'المتحكم', en: 'Controller' }, value: 'mini STM32' },
      { label: { ar: 'المنافذ', en: 'Ports' }, value: 'USB HUB' },
      { label: { ar: 'الهيكل', en: 'Frame' }, value: 'Metal frame + mobile base' },
    ],
    hardware: [
      { label: { ar: 'كاميرا Depth 3D', en: '3D depth camera' }, side: 'start' },
  ...
  },
  {
    ...
    gallery: [
      ...
      '/robots/ugot-render-3.webp',
      '/robots/ugot-render-4.webp',
      '/robots/ugot-render-5.webp',
      '/robots/ugot-render-6.webp',
      '/robots/ugot-render-7.webp',
      '/robots/ugot-real-1.webp',
      '/robots/ugot-real-2.webp',
      '/robots/ugot-real-3.webp',
      '/robots/ugot-real-4.webp',
      '/robots/ugot-real-5.webp',
      '/robots/ugot-real-6.webp',
      '/robots/ugot-real-7.webp',
      '/robots/ugot-real-8.webp',
      '/robots/ugot-real-9.webp',
    ],
    tagline: { ar: 'روبوت تعليمي', en: 'Educational robot' },
    summary: {
  ...
  // ══════════════════════ رباعية ══════════════════════
  {
    ...
    specs: [
      ...
      { label: { ar: 'البرمجة', en: 'Programming' }, value: 'Graphical (drag & drop) programming + official SDK + ROS support' },
      { label: { ar: 'التخصيص', en: 'Customisation' }, value: 'Hardware customizable to fit needs & budget' },
    ],
    hardware: [
  ...
  },
  {
    ...
    gallery: [
      ...
      '/robots/unitree-g1-real-1.webp',
      '/robots/unitree-g1-real-2.webp',
      '/robots/unitree-g1-real-3.webp',
      '/robots/unitree-g1-real-4.webp',
      '/robots/unitree-g1-real-5.webp',
      '/robots/unitree-g1-real-6.webp',
    ],
    ...
    specs: [
      ...
      { label: { ar: 'اليد (اختياري)', en: 'Single hand DoF (optional)' }, value: '7 + 2 (extra wrist)' },
      ...
      { label: { ar: 'البطارية الذكية', en: 'Smart battery' }, value: '9000 mAh (quick-release)' },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: { ar: 'درجات الحرية الكلية', en: 'Total degrees of freedom' }, value: '23 (expandable to 41 with dexterous hand)' },
      ...
      { label: { ar: 'الاستشعار', en: 'Sensing' }, value: 'Depth camera + 9-axis IMU' },
      { label: { ar: 'الصوت', en: 'Audio' }, value: '6-mic circular array + speaker' },
      { label: { ar: 'البطارية', en: 'Battery' }, value: '10.5 Ah — 2h walking / 4h standing' },
      { label: { ar: 'الاتصال اللاسلكي', en: 'Wireless' }, value: 'Wi-Fi 6 + Bluetooth 5.2' },
      { label: { ar: 'منافذ التوسعة', en: 'Expansion ports' }, value: 'USB + Ethernet' },
      { label: { ar: 'الضمان', en: 'Warranty' }, value: 'One year' },
    ],
    hardware: [
