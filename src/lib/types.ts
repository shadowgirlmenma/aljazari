...
export interface Robot {
  ...
  image: string;
  /**
   * نسخة موحّدة لبطاقات الروبوتات (public/robots/card/<slug>.webp) — الروبوت مقصوص على
   * حدوده ومتوسّط بنفس المساحة بمربع 800×800 شفاف، حتى تظهر كل الروبوتات بنفس الحجم
   * المنطقي داخل البطاقات. اختياري: إذا غاب نستخدم `image`.
   */
  cardImage?: string;
  /**
